<%@ Page Title="" Language="C#" MasterPageFile="~/DosenDashboard.Master" AutoEventWireup="true" CodeFile="NilaiKKP.aspx.cs" Inherits="NilaiKKP" %>
...
<body>
                ...
                <td class="form-section">
                    <table>
                        ...
                        <tr>
                            <td>Prestasi</td>
                            <td>:</td>
                            <td><asp:TextBox runat="server" Text="" ID="txtprestasi"></asp:TextBox></td>
                        </tr>
                    </table>
                </td>
            </tr>
    ...
    <asp:GridView ID="grc1" runat="server" BackColor="White" BorderColor="#cccccc" BorderStyle="None" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="false">
        <Columns>
            ...
            <asp:BoundField HeaderText="Prestasi" DataField="prestasi" />
            <asp:BoundField HeaderText="Total" DataField="total" />
            <asp:BoundField HeaderText="Hasil Akhir" DataField="rata_rata" />
            <asp:BoundField HeaderText="Grade" DataField="grade" />
            <asp:TemplateField HeaderText="Action">
                <ItemTemplate>
                    <asp:LinkButton ID="lnkCetak" runat="server" CommandArgument='<%# Eval("id_kkp") %>' OnClick="lnkCetak_Click" ToolTip="Cetak" CssClass="btn-pdf">
                        <i class="fas fa-print btn-icon"></i> Cetak
                    </asp:LinkButton>
                    <asp:LinkButton ID="lnkEdit" runat="server" CommandArgument='<%# Eval("id_kkp") %>' OnClick="lnkEdit_Click" ToolTip="Edit" CssClass="btn-edit">
